...
const calendar = document.querySelector('.curator__data')
if (calendar) {
  document
    .querySelector('.icon-cheveron-left')
    .addEventListener('click', () => {
      currentMonth === 0 ? (currentMonth = 11) : currentMonth--
      document.querySelector('.curator__data-month').textContent =
        months[currentMonth]
      console.log(currentMonth)
    })

  document
    .querySelector('.icon-cheveron-right')
    .addEventListener('click', () => {
